...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <meta name="description" content="Homenaje a la Herencia Huanuqueña Café">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="autor" content="HHH Cafe">
    <link rel="shortcut icon" href="<?= media();?>/images/hhhcafe.ico">
  ...
  <body class="app sidebar-mini">
    ...
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="<?= base_url(); ?>/dashboard">Cafe Administrador</a>
