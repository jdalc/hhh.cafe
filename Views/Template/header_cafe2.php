...
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="<?= media() ?>/pagina/vendor/select2/select2.min.css">
<!--===============================================================================================-->	
	<link rel="stylesheet" type="text/css" href="<?= media() ?>/pagina/vendor/daterangepicker/daterangepicker.css">
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="<?= media() ?>/pagina/vendor/slick/slick.css">
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="<?= media() ?>/pagina/vendor/MagnificPopup/magnific-popup.css">
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="<?= media() ?>/pagina/vendor/perfect-scrollbar/perfect-scrollbar.css">
<!--===============================================================================================-->
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop p-l-100">
					...
					<a href="<?= base_url(); ?>" class="logo-header">
						<img src="<?= media() ?>/pagina/img/logo3.png" alt="IMG-LOGO">
					</a>
						...
						<div class="flex-c-m h-full p-lr-19">
                                <div class="icon-header-item-1 cl0 hov-cl3 trans-04 p-lr-11">
									<?php if(isset($_SESSION['login'])) { ?>
										<a class="cl5 hov-cl3 trans-04" href="<?= base_url() ?>/dashboard">
											<i class="fa fa-user p-r-5"></i>
											<?= $_SESSION['userData']['nombres'].' '.$_SESSION['userData']['apellidos'] ?>
										</a>
									<?php } else { ?>
										<a href="<?= base_url() ?>/login" class="cl5 hov-cl3 trans-04">
											<i class="fa fa-user p-r-5"></i>
												Iniciar Sesión
										</a>
									<?php } ?>
